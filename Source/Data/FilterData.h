...
public:
    ...
    // Notice that the modulator is just a number (or float)! Whatever class we choose to modulate this with, its really just outputting numbers, just like CV in a eurorack system.
